  ...
  const mealsData: Meal[] = [
    {
      ...
      description: "A delicious and healthy meal featuring grilled salmon fillet served with fresh asparagus and lemon.",
      category: "Seafood",
      mealType: "Dinner",
      calories: 420,
      protein: 38,
      carbs: 12,
      fats: 25,
      ingredients: ["Salmon fillet", "Asparagus", "Olive oil", "Lemon", "Garlic", "Salt", "Black pepper", "Dill"],
      steps: [
